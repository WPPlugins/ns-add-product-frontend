...
add_action( 'admin_menu', function()  {
    add_menu_page( 'Add Prod', 'Add Prod', 'manage_options', untrailingslashit( dirname( __FILE__ ) ).'/ns_admin_option_dashboard.php', '', plugin_dir_url( __FILE__ ).'img/backend-sidebar-icon.png', 60);
...
add_action( 'admin_enqueue_scripts', function() {
	...
	wp_enqueue_style('ns-option-css-a-page', plugin_dir_url( __FILE__ ) . 'css/ns-option-css-custom-page.css');
